...
heroImage: "/img/writeups/2024/UMDCTF-24/umdctf-24-hero.png"
---
...
<CollapsableCodeBlock filename="the_voice.c">
```c
#include <stdio.h>
#include <stdlib.h>
...
Here's the source:
<CollapsableCodeBlock filename="mentat_question.c">
```c
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
<CollapsableCodeBlock filename="the_spice.c">
```c
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
<CollapsableCodeBlock filename="templates.hpp">
```cpp
#include <type_traits>
...
<CollapsableCodeBlock filename="main.cpp">
```cpp
