...
<CollapseBlock filename="the_voice.c">
```c
#include <stdio.h>
#include <stdlib.h>
...
Here's the exploit:
<CollapseBlock filename="solve.py">
```python
#!/usr/bin/env python3
from pwn import *
...
Here's the source:
<CollapseBlock filename="mentat_question.c">
```c
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
<CollapseBlock filename="the_spice.c">
```c
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
<CollapseBlock filename="templates.hpp">
```cpp
#include <type_traits>
...
<CollapseBlock filename="main.cpp">
```cpp
