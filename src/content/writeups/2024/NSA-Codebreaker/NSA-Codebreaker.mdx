...
As it turns out, the correct intention was indeed to bruteforce, but instead of base 10 digits, it was hex digits. I just got really lucky that the 3 characters used happened to be all digits.
...
<CollapsableCodeBlock filename="main()">
```c++
